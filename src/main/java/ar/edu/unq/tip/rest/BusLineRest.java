...
public class BusLineRest {
	...
	public void setBusLineService(BusLineService busLineService) {
		...
		Bus bus1 = new Bus(1, "10 a Recoleta", new Position(-34.779671, -58.262805), routeEncode1, routeEncode1, new ArrayList<Position>(), new ArrayList<Position>());
		...
		Bus bus2 = new Bus(2, "159 a Correo Central", new Position(-34.770671, -58.261805), routeEncode2, routeEncode2, new ArrayList<Position>(), new ArrayList<Position>());
		String routeEncode3 = "htyrEzhubJnSsi@kVyJrEmPjc@ccA?sH"; 
		Bus bus3 = new Bus(3, "159 a Correo Central", new Position(-34.779250, -58.262101), routeEncode3, routeEncode3, new ArrayList<Position>(), new ArrayList<Position>());
		...
		Bus bus4 = new Bus(4, "98 a Plaza Once", new Position(-34.777771, -58.263524), routeEncode4, routeEncode4, new ArrayList<Position>(), new ArrayList<Position>());
